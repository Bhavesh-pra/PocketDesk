"""
PDF processing orchestrator (pypdfium2 / PDFium variant).
...
from app.config import MIN_NATIVE_TEXT_CHARS
from app.services.ocr_service import is_tesseract_available, ocr_page
from app.services.pdf_extractor import extract_page_text, open_pdf
